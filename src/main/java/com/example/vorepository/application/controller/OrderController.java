package com.example.vorepository.application.controller;

import com.example.vorepository.application.controller.dto.AddProductRequest;
import com.example.vorepository.application.controller.dto.CreateOrderRequest;
...
public class OrderController {
    ...
    void createOrder(@RequestBody CreateOrderRequest request) {
        orderService.createOrder(request.getId(), request.getProduct());
    }
